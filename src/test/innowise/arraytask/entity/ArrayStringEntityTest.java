package test.innowise.arraytask.entity;
...
class ArrayStringEntityTest {
    private ArrayStringBuilder builder;
    private ArrayStringEntity arrayEntity;
    private String[] testArray;
    
    @BeforeEach
    void setUp() {
        builder = new ArrayStringBuilder();
    ...
    void testCreateEmpty() {
        ArrayStringEntity emptyArray = builder.createEmpty(3);
