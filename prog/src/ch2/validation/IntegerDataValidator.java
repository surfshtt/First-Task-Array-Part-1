...
public class IntegerDataValidator {
    ...
    public List<Integer> validateAndParse(String line) throws DataValidationException {
        ...
        if (result.isEmpty()) {
            throw new DataValidationException("Не найдено ни одного корректного числа");
        }
